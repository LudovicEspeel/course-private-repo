...
void InitUsart2(uint32_t baudRate)
{
	...
	GPIOA->AFR[0] |= 0x00000100;																								// USART2_TX is alternate function AF1 (zie datasheet STM32F091RC, p. 43).

	// PA3 => RX-pin
	GPIOA->MODER = (GPIOA->MODER & ~GPIO_MODER_MODER3) | GPIO_MODER_MODER3_1;		// Alternate function op PA3.
	GPIOA->AFR[0] |= 0x00001000;																								// USART2_RX is alternate function AF1 (zie datasheet STM32F091RC, p. 43).
	...
	// Reception overrun uitschakelen. Als nieuwe byte aankomt terwijl
